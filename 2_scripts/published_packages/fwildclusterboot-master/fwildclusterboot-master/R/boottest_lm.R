...
#'
# '@section Different Bootstrap Algorithms
#' Via the `engine` function argument, it is possible to specify different
...
...) {
 ...
 check_arg(bootstrap_type, "charin(11, 21, 13, 31, 33, fnw11)")
