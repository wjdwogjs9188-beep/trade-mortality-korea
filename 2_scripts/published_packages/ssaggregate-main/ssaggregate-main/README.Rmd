...
When the `controls` option is included the location-level variables are first residualized by the control variables. Formula following `feols`. Fixed effects specified after "`|`".The transformation of variable `y` is also named `y`.
