...
Outputs:
  - 4_results/regression/main_spec_5layer_se.csv
  - 4_results/regression/romano_wolf_pvalues.csv
  - 4_results/regression/sub_period_split_2008.csv
  - 5_logs/decisions/<date>_phase4_final_inference.md
...
def main() -> None:
    ...
    main_df.to_csv(OUT_REG / "main_spec_5layer_se.csv", index=False, encoding="utf-8-sig")
    ...
    rw_df.to_csv(OUT_REG / "romano_wolf_pvalues.csv", index=False, encoding="utf-8-sig")
    log.append("```")
    log.append(rw_df.to_string(index=False))
    log.append("```")
    log.append(f"- saved: `4_results/regression/romano_wolf_pvalues.csv`")
    ...
    sub_df.to_csv(OUT_REG / "sub_period_split_2008.csv", index=False, encoding="utf-8-sig")
    log.append(f"- saved: `4_results/regression/sub_period_split_2008.csv`")
    ...
    out_path = OUT_LOG / f"{TODAY}_phase4_final_inference.md"
