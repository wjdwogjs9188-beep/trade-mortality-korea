# 5_logs — 본 paper 의 결정·진단·방법론 archive index

_2026-05-06 R-A 작성 (file 이동 없는 README index, navigability 회복용)_

본 paper (Trade × Mortality Korea) 의 모든 결정 commit, build 진단, 방법론 note, data 수집 log 가 이 폴더 아래 archive 되어 있습니다.
...
│   └── README.md
└── data_collection/                (12 data fetch progress log — Phase 1 archive)
    └── README.md
```
...
| 본 paper 의 pre-analysis plan 자체 | `pre_analysis_plan.md` (5_logs/ root) |

---

## Cross-reference

- paper 본문: `7_paper/paper_draft_v01_section_*.md`
